...
const iconMap = [Building2, Users, CreditCard, Wrench, FileText, Bell];
const featureKeys = ['management', 'tenantPortal', 'payments', 'maintenance', 'agreements', 'notifications'] as const;
            ...
            return (
              ...
              >
                ...
                <div className="relative">
                  ...
                  <p className="text-sm leading-relaxed" style={{ color: 'var(--text-light)' }}>{t(`${key}.desc`)}</p>
                </div>
              </motion.div>
            );
          })}
