    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Properties by {agentName}</h1>
          <p className="text-lg text-gray-500 max-w-2xl mx-auto">Browse available properties listed by this agent.</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h3 className="font-semibold text-lg mb-2">No Properties Listed</h3>
            <p className="text-gray-500">This agent has no available properties at the moment.</p>
          </div>
        ) : (
